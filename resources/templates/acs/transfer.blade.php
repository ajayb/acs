<form class="form-horizontal fv-form fv-form-bootstrap" method="post" name="transferCarbonForm" id="transferCarbonForm" >   
    <input type="hidden" id="_token" name="_token" value="{{csrf_token()}}">
    <input type="hidden" id="addType" name="addType" value="transfer">
    <div class="modal-header">
        <button type="button" class="close cancel" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title" id="simpleModalLabel">Transfer</h4>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="form-group">
                        ...
                        <div id="transferDateTimePicker" class="col-md-8 col-sm-9 input-group control-width-normal date datetimepicker">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn mod-action" id="saveTransferCarbon">Save</button>        
        <button type="button" class="btn cancel" data-dismiss="modal">Cancel</button>
    </div>
</form> 
<script type="text/javascript">
    addDatePicker('transferDateTimePicker');
