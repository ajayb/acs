<form class="form-horizontal fv-form fv-form-bootstrap" method="post" name="grantCarbonForm" id="grantCarbonForm" >   
    <input type="hidden" id="_token" name="_token" value="{{csrf_token()}}">
    <input type="hidden" id="addType" name="addType" value="grant">
    <div class="modal-header">
        <button type="button" class="close cancel" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title" id="simpleModalLabel">Grant</h4>
    </div>
                ...
                <div class="col-lg-8">
                    <div class="form-group">
                        <div class="col-md-4 col-sm-3">
                            <label for="organization" class="control-label">Non Profit Org.</label>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="form-group">
                        ...
                        <div id="grantDateTimePicker" class="col-md-8 col-sm-9 input-group control-width-normal date datetimepicker">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn mod-action" id="saveGrantCarbon">Save</button>        
        <button type="button" class="btn cancel" data-dismiss="modal">Cancel</button>
    </div>
</form> 
<script type="text/javascript">
    addDatePicker('grantDateTimePicker');
    addTypeahead('organization', 'organization', 0, 0);
    addEvents();
    saveGrantCarbon();
    /*
     $(".clsClear").on('click', function () {
     $('#grantCarbonForm')[0].reset();
     });
     */
</script>